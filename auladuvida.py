...
janela = Tk() 
janela.title("Acesso ao Programa")
#janela.geometry("250x400")
janela.config(bg="#F0F8FF")
#janela.maxsize(width=250, height=400)
#janela.minsize(width=250, height=400)


texto1 = Label(janela, text="Clirque aqui para nova janela", font=("Arial", 12), bg="#F0F8FF")
texto1.grid(column=0, row=0, padx=10, pady=10)


botaoclientes = Button(janela, text="Clientes", font=("Arial", 10), bg="#E6E6FA", fg="#000000", relief="raised")
botaoclientes.grid(column=0, row=1, padx=55, pady=10)

botaoprodutos = Button(janela, text="Produtos", font=("Arial", 10), bg="#E6E6FA", fg="#000000", relief="raised",)
botaoprodutos.grid(column=0, row=2, padx=55, pady=10)

comprascliente = Button(janela, text="Compras/Clientes", font=("Arial", 10), bg="#E6E6FA", fg="#000000", relief="raised")
comprascliente.grid(column=0, row=3, padx=55, pady=10)

label_mensagem = Label(janela, text="", font=("Arial", 10, "bold"), bg="#F0F8FF", fg="green")
label_mensagem.grid(column=0, row=4, pady=10)
...
texto1 = Label(janela, text="Digite os dados para Cadastrar os Produtos:", font=("Arial", 12), bg="#F0F8FF")
texto1.grid(column=0, row=0, padx=10, pady=10, columnspan=2)


label_nomeproduto = Label(janela, text='Nome do Produto:', font=("Arial", 10), bg="#F0F8FF")
label_nomeproduto.grid(row=1, column=0, padx=10, pady=5, sticky="w")
entry_nomeproduto = Entry(janela, width=35, font=("Arial", 10))
entry_nomeproduto.grid(row=1, column=1, padx=10, pady=5)

label_valorproduto = Label(janela, text='Valor do Produto:', font=("Arial", 10), bg="#F0F8FF")
label_valorproduto.grid(row=2, column=0, padx=10, pady=5, sticky="w")
entry_valorproduto = Entry(janela, width=35, font=("Arial", 10))
entry_valorproduto.grid(row=2, column=1, padx=10, pady=5)


botaonovoproduto = Button(janela, text="Novo Produto", font=("Arial", 10), bg="#E6E6FA", fg="#000000", relief="raised")
botaonovoproduto.grid(column=0, row=7, padx=10, pady=10)

botaoexcluirproduto = Button(janela, text="Excluir Produto", font=("Arial", 10), bg="#E6E6FA", fg="#000000", relief="raised")
botaoexcluirproduto.grid(column=1, row=7, padx=10, pady=10)

botaoeditarproduto = Button(janela, text="Editar Produto", font=("Arial", 10), bg="#E6E6FA", fg="#000000", relief="raised")
botaoeditarproduto.grid(column=1, row=8, padx=10, pady=10)
